...
namespace TouchControlsKit.Inspector
{
    public static class TCKPrefabCreator
    {
        ...
        private static void CreateTouchManager()
        {
            ...
            Array.ForEach( Object.FindObjectsByType<Camera>(FindObjectsInactive.Include, FindObjectsSortMode.None), cam => maxCameraDepth = Mathf.Max( cam.depth, maxCameraDepth ) );
        ...
        {
            CreateTouchManager();
            SetupController<TCKButton>( ref buttonObj, tckUIobj.transform, "Button" + Object.FindObjectsByType<TCKButton>(FindObjectsInactive.Include, FindObjectsSortMode.None).Length, true );
        ...
        {
            CreateTouchManager();
            SetupController<TCKJoystick>( ref joystickMainObj, tckUIobj.transform, "Joystick" + Object.FindObjectsByType<TCKJoystick>(FindObjectsInactive.Include, FindObjectsSortMode.None).Length, true );
        ...
        {
            CreateTouchManager();
            SetupController<TCKTouchpad>( ref touchpadObj, tckUIobj.transform, "Touchpad" + Object.FindObjectsByType<TCKTouchpad>(FindObjectsInactive.Include, FindObjectsSortMode.None).Length, true );
